...
export function LeadershipCard({ user }: { user: User }) {
  ...
  return (
    <div className="bg-linear-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20 rounded-xl p-4 flex flex-col items-center text-center transition-all duration-300 backdrop-blur-sm hover:-translate-y-1 hover:border-amber-400/40 hover:shadow-[0_10px_30px_rgba(245,158,11,0.15)]">
